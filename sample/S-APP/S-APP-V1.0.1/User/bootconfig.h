...
#define INFO_MCUTYPE      	CODE_M0518LD2AE				//芯片序号
#define INFO_PCBID			0								//灯内的PCB板序号
#define INFO_MCUID			1								//PCB板上多块MCU的序号
#define INFO_VERSION      	0x10//BOOTLoader的版本必须使用大版本0x10，0x20，0x30，0x40

#define DS_Info_Chip_IC     'M','0','5','1','8','L','D','2','A','E',',',',',',',' ',' ',' '


#define DS_Info_Chip_ADDR     0x00000800
#define DS_Info_Anthor_ADDR   0x00000810
#define DS_Info_Device_ADDR   0x00000820
#define DS_Info_Function_ADDR 0x00000830

	#define PLLCON_SETTING      CLK_PLLCON_50MHz_HXT
	#define PLL_CLOCK           50000000
	
	#if DMX_Enable
	#define RS_DMX_DE_PORT      PB2
	#define RS_DMX_Pin      BIT2
	#define RS_DMX_PORT     PB
	#define DMX512_Master   RS_DMX_DE_PORT=1
	#define DMX512_Slave    RS_DMX_DE_PORT=0
	#define UART1_Enable  1 
	#define DMX_UART    UART0
	#define DMX_UARTIRQHandler   UART02_IRQHandler
	#endif
	...
	#define D485_UART   UART1
	#define D485_UARTIRQHandler  UART1_IRQHandler
	#endif
