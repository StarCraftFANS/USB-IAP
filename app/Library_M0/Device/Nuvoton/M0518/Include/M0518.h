...
/**
  ...
  *
  *
  * This user manual describes the usage of M0518 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_M0518.h"               /* M0518 System                                           */
...
typedef struct
{
     ...
     * | :----: | :----:   | :---- |
     * |[0:15]  |RSLT      |A/D Conversion Result
     ...
     * |[6:7]   |TRGCOND   |External Trigger Condition
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:7]   |CHEN      |Analog Input Channel Enable
     ...
     * |[8:9]   |PRESEL    |Analog Input Channel 7 Select
     ...
     * |[3:5]   |CMPCH     |Compare Channel Selection
     ...
     * |[8:11]  |CMPMATCNT |Compare Match Count
     ...
     * |        |          |It is read only.
     * |[4:6]   |CHANNEL   |Current Conversion Channel
     ...
     * |        |          |It is read only.
     * |[8:15]  |VALID     |Data Valid Flag
     * |        |          |It is a mirror of VALID bit (ADDR0~7[17]).
     * |        |          |It is read only.
     * |[16:23] |OVERRUN   |Overrun Flag
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:17]  |AD_PDMA   |ADC PDMA Current Transfer Data Register
...
typedef struct
{
     ...
     * |        |          |The flag is set if the GPIO, UART, WDT, I2C, TIMER, BOD or RTC wake-up occurred
    ...
    */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:2]   |HCLK_S    |HCLK Clock Source Select (Write Protect)
     ...
     * |        |          |Note: This bit is the protected bit, and programming it needs to write "59h", "16h", and "88h" to address 0x5000_0100 to disable register protection.
     * |        |          |Refer to the register REGWRPROT at address GCR_BA+0x100.
     * |[3:5]   |STCLK_S   |Cortex-M0 SysTick Clock Source Select (Write Protect)
     ...
     * |[8:10]  |TMR0_S    |TIMER0 Clock Source Selection
     * |        |          |000 = Clock source from external 4~24 MHz high speed crystal clock.
     ...
     * |        |          |111 = Clock source from internal 22.1184 MHz high speed oscillator clock.
     * |        |          |Others = reserved.
     * |[12:14] |TMR1_S    |TIMER1 Clock Source Selection
     * |        |          |000 = Clock source from external 4~24 MHz high speed crystal clock.
     * |        |          |010 = Clock source from HCLK.
     * |        |          |011 = Clock source from external trigger.
     * |        |          |101 = Clock source from internal 10 kHz low speed oscillator clock.
     * |        |          |111 = Clock source from internal 22.1184 MHz high speed oscillator clock.
     * |        |          |Others = reserved.
     * |[16:18] |TMR2_S    |TIMER2 Clock Source Selection
     * |        |          |000 = Clock source from external 4~24 MHz high speed crystal clock.
     * |        |          |010 = Clock source from HCLK.
     * |        |          |011 = Clock source from external trigger.
     * |        |          |101 = Clock source from internal 10 kHz low speed oscillator clock.
     * |        |          |111 = Clock source from internal 22.1184 MHz high speed oscillator clock.
     * |        |          |Others = reserved.
     * |[20:22] |TMR3_S    |TIMER3 Clock Source Selection
     * |        |          |000 = Clock source from external 4~24 MHz high speed crystal clock.
     * |        |          |010 = Clock source from HCLK.
     * |        |          |011 = Clock source from external trigger.
     * |        |          |101 = Clock source from internal 10 kHz low speed oscillator clock.
     * |        |          |111 = Clock source from internal 22.1184 MHz high speed oscillator clock.
     * |        |          |Others = reserved.
     * |[24:25] |UART_S    |UART Clock Source Selection
     * |        |          |00 = Clock source from external 4~24 MHz high speed crystal oscillator clock.
     * |        |          |01 = Clock source from PLL clock.
     * |        |          |11 = Clock source from internal 22.1184 MHz high speed oscillator clock.
     */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:3]   |HCLK_N    |HCLK Clock Divide Number From HCLK Clock Source
     * |        |          |HCLK clock frequency = (HCLK clock source frequency) / (HCLK_N + 1).
     * |[8:11]  |UART_N    |UART Clock Divide Number From UART Clock Source
     * |        |          |UART clock frequency = (UART clock source frequency) / (UART_N + 1).
     * |[16:23] |ADC_N     |ADC Clock Divide Number From ADC Clock Source
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[2:3]   |FRQDIV_S  |Clock Divider Clock Source Selection
     * |        |          |00 = Clock source from external 4~24 MHz high speed crystal oscillator clock.
     * |        |          |10 = Clock source from HCLK.
     * |        |          |11 = Clock source from internal 22.1184 MHz high speed oscillator clock.
     * |[16:17] |WWDT_S    |Window Watchdog Timer Clock Source Selection
     * |        |          |10 = Clock source from HCLK/2048 clock.
     * |        |          |11 = Clock source from internal 10 kHz low speed oscillator clock.
     */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:8]   |FB_DV     |PLL Feedback Divider Control Bits
     * |        |          |Refer to the formulas below the table.
     * |[9:13]  |IN_DV     |PLL Input Divider Control Bits
     * |        |          |Refer to the formulas below the table.
     * |[14:15] |OUT_DV    |PLL Output Divider Control Bits
     * |        |          |Refer to the formulas below the table.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:3]   |FSEL      |Divider Output Frequency Selection Bits
...
typedef struct
{
     ...
     * |        |          |NuMicro M0518 series has a maximum of 17Kx32(68KB) embedded Flash, which supports word program only.
...
/** @addtogroup GPIO General purpose I/O (GPIO)
  Memory Mapped Structure for M0518 Series General Purpose I/O
  @{
 */
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[16:31] |OFFD      |GPIOx Pin[N] Digital Input Path Disable Control
...
typedef struct
{
     ...
     * |[1:7]   |I2CADDR   |I2C Address Register
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:7]   |I2CSTATUS |I2C Status Register
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:7]   |I2CLK     |I2C clock divided Register
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[1:7]   |I2CADM    |I2C Address Mask Register
...
typedef struct
{
     ...
     * |[3:7]   |TX_BIT_LEN|Transmit Bit Length
     ...
     * |[12:15] |SP_CYCLE  |Suspend Interval (Master Only)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:7]   |DIVIDER   |Clock Divider 1 Register
     ...
     * |[16:23] |DIVIDER2  |Clock Divider 2 Register (Master Only)
     ...
     * |[24:26] |RX_THRESHOLD|Receive FIFO Threshold
     ...
     * |[28:30] |TX_THRESHOLD|Transmit FIFO Threshold
     ...
     * |[12:15] |RX_FIFO_COUNT|Receive FIFO Data Count (Read Only)
     ...
     * |        |          |0 = Transmit FIFO buffer is not full.
     * |        |          |1 = Transmit FIFO buffer is full.
     * |[28:31] |TX_FIFO_COUNT|Transmit FIFO Data Count (Read Only)
...
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:31]  |PDID      |Part Device Identification Number
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:15]  |POR_DIS_CODE|Power-On-Reset Enable Control (Write Protect)
...
typedef struct
{
    ...
    union
    {
         ...
         * |Bits    |Field     |Descriptions
         * | :----: | :----:   | :---- |
         * |[0:7]   |RBR       |Receive Buffer Register (Read Only)
     ...
     * |[16:19] |RTS_TRI_LEV|RTS Trigger Level For Auto-Flow Control Use (Available In UART0/UART1 Channel)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[1]     |RTS       |RTS (Request-To-Send) Signal Control(Available In UART0/UART1 Channel)
     ...
     * |[9]     |LEV_RTS   |RTS Pin Active Level (Available In UART0/UART1 Channel)
     ...
     * |[13]    |RTS_ST    |RTS Pin State (Read Only) (Available In UART0/UART1 Channel)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0]     |DCTSF     |Detect CTS State Change Flag (Read Only) (Available In UART0/UART1 Channel)
     ...
     * |[4]     |CTS_ST    |CTS Pin Status (Read Only) (Available In UART0/UART1 Channel)
     ...
     * |        |          |Note: This bit is read only, but can be cleared by writing "1" to it.
     * |[8:13]  |RX_POINTER|RX FIFO Pointer (Read Only)
     ...
     * |[16:21] |TX_POINTER|TX FIFO Pointer (Read Only)
     ...
     * UA_IRCR
     * ===================================================================================================
     * Offset: 0x28  UART IrDA Control Register (Available in UART0/UART1/UART2 channel)
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:3]   |LIN_BKFL  |UART LIN Break Field Length (Available In UART0/UART1/UART2)
     ...
     * |[19:20] |ABRDBITS  |Auto-Baud Rate Detect Bit Length
     ...
     * |[24:31] |ADDR_MATCH|Address Match Value Register (Available In UART0/UART1)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[0:1]   |FUN_SEL   |Function Select Enable
     ...
     * |        |          |If the LIN_IEN (UA_IER[8]) = 1, an interrupt will be generated.
     * |[16:19] |LIN_BKFL  |LIN Break Field Length
     * |        |          |This field indicates a 4-bit LIN TX break field count.
     ...
     * |[20:21] |LIN_BS_LEN|LIN Break/Sync Delimiter Length
     ...
     * |[22:23] |LIN_HEAD_SEL|LIN Header Select
     ...
     * |[24:31] |LIN_PID   |LIN PID Register
...
/** @addtogroup WWDT_CONST Bit Mask Definition
  @{
 */
