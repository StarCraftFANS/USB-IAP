 ...
 * $Revision: 1 $
 * $Date: 14/10/03 1:24p $
 * @brief    M0518 series WDT driver header file
 *
 * @note
...
/** @addtogroup M0518_WDT_Driver WDT Driver
  @{
*/

/** @addtogroup M0518_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group M0518_WDT_EXPORTED_CONSTANTS */


/** @addtogroup M0518_WDT_EXPORTED_FUNCTIONS WDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group M0518_WDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0518_WDT_Driver */
