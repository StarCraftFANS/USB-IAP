 ...
 * $Revision: 3 $
 * $Date: 14/12/24 3:00p $
 * @brief    M0518 series Timer driver header file
 *
 * @note
...
/** @addtogroup M0518_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup M0518_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
#define TIMER_CAPTURE_FALLING_EDGE              (0UL << TIMER_TEXCON_TEX_EDGE_Pos)  /*!< Falling edge detection to trigger timer capture */
#define TIMER_CAPTURE_RISING_EDGE               (1UL << TIMER_TEXCON_TEX_EDGE_Pos)  /*!< Rising edge detection to trigger timer capture */
#define TIMER_CAPTURE_FALLING_AND_RISING_EDGE   (2UL << TIMER_TEXCON_TEX_EDGE_Pos)  /*!< Both falling and rising edge detection to trigger timer capture */
#define TIMER_COUNTER_FALLING_EDGE              (0UL << TIMER_TEXCON_TX_PHASE_Pos)  /*!< Counter increase on falling edge detection */
#define TIMER_COUNTER_RISING_EDGE               (1UL << TIMER_TEXCON_TX_PHASE_Pos)  /*!< Counter increase on rising edge detection */

/*@}*/ /* end of group M0518_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup M0518_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/**
  ...
  * @note       To wake the system from Power-down mode, timer clock source must be LIRC.
  */
...
/*@}*/ /* end of group M0518_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0518_TIMER_Driver */
