 ...
 * $Revision: 3 $
 * $Date: 14/12/24 4:27p $
 * @brief    M0518 Series I2C Driver Header File
 *
 * @note
...
/** @addtogroup M0518_I2C_EXPORTED_CONSTANTS I2C Exported Constants
  @{
*/
...
/*@}*/ /* end of group M0518_I2C_EXPORTED_CONSTANTS */
