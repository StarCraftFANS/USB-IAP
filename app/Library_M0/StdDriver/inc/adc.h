 ...
 * $Revision: 2 $
 * $Date: 14/10/07 9:37a $
 * @brief    M0518 Series ADC Driver Header File
 *
 * @note
...
/** @addtogroup M0518_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup M0518_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group M0518_ADC_EXPORTED_CONSTANTS */

/** @addtogroup M0518_ADC_EXPORTED_FUNCTIONS ADC Exported Functions
  @{
*/
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @return None
  * @details Set CMPEN (ADCMPR0[0]) to 1 to disable ADC controller to compare CMPD (ADCMPR0[27:16]).
  */
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @return None
  * @details Set CMPEN (ADCMPR1[0]) to 1 to disable ADC controller to compare CMPD (ADCMPR1[27:16]).
  */
...
/**
  ...
  * @note M0518 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
...
/*@}*/ /* end of group M0518_ADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0518_ADC_Driver */
