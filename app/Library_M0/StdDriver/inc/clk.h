 ...
 * $Revision: 4 $
 * $Date: 14/12/04 2:44p $
 * @brief    M0518 Series Clock Control Driver Header File
 *
 * @note
...
/** @addtogroup M0518_CLK_EXPORTED_CONSTANTS CLK Exported Constants
  @{
*/
...
/*@}*/ /* end of group M0518_CLK_EXPORTED_CONSTANTS */
