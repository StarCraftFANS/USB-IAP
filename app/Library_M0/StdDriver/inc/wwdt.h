 ...
 * $Revision: 2 $
 * $Date: 14/10/03 5:24p $
 * @brief    M0518 series WWDT driver header file
 *
 * @note
...
/** @addtogroup M0518_WWDT_Driver WWDT Driver
  @{
*/

/** @addtogroup M0518_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group M0518_WWDT_EXPORTED_CONSTANTS */


/** @addtogroup M0518_WWDT_EXPORTED_FUNCTIONS WWDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group M0518_WWDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0518_WWDT_Driver */
