 ...
 * $Revision: 3 $
 * $Date: 14/12/01 8:54a $
 * @brief    M0518 Series General Purpose I/O Driver Header File
 *
 * @note
...
/** @addtogroup M0518_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group M0518_GPIO_EXPORTED_CONSTANTS */
