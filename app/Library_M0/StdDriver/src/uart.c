 ...
 * @brief    M0518 series UART driver source file
 *
 * @note
...
/** @addtogroup M0518_UART_Driver UART Driver
  @{
*/

/** @addtogroup M0518_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
 ...
 *                                      - UART_ISR_DATWKIF_Msk      : Data Wake-up interrupt
 *                                      - UART_ISR_CTSWKIF_Msk      : CTS Wake-up interrupt
...
void UART_ClearIntFlag(UART_T* uart , uint32_t u32InterruptFlag)
{
    ...
    if(u32InterruptFlag & UART_ISR_CTSWKIF_Msk)   /* Clear CTS Wake-up Interrupt */
    {
        uart->ISR = UART_ISR_CTSWKIF_Msk;
    }

    if(u32InterruptFlag & UART_ISR_DATWKIF_Msk)   /* Clear Data Wake-up Interrupt */
    {
        uart->ISR = UART_ISR_DATWKIF_Msk;
    }

    if(u32InterruptFlag & UART_ISR_LIN_INT_Msk)   /* Clear LIN bus Interrupt */
    {
...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    uart->LCR = UART_WORD_LEN_8 | UART_PARITY_NONE | UART_STOP_BIT_2;
...
/*@}*/ /* end of group M0518_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M0518_UART_Driver */
