 ...
 * $Revision: 4 $
 * $Date: 14/12/24 4:19p $
 * @brief    M0518 series I2C driver source file
 *
 * @note
...
/** @addtogroup M0518_I2C_Driver I2C Driver
  @{
*/


/** @addtogroup M0518_I2C_EXPORTED_FUNCTIONS I2C Exported Functions
  @{
*/
...
/**
  ...
  *
  * @param[in]  i2c         Specify I2C port
  * @param[in]  u8Start     Set I2C START condition(0/1)
  * @param[in]  u8Stop      Set I2C STOP condition(0/1)
  * @param[in]  u8Si        Set/Clear SI flag(0/1)
  * @param[in]  u8Ack       Set I2C ACK bit(0/1)
  *
  * @return     None
  *
...
/*@}*/ /* end of group M0518_I2C_EXPORTED_FUNCTIONS */
